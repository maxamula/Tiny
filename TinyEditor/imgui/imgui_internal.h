...
namespace ImGui
{
    ...
    // Init
    IMGUI_API void          InitializeGridPass();
    IMGUI_API void          ShutdownGridPass();    // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().
